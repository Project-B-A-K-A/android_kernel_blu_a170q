...
static kal_bool GC5005DuringTestPattern = KAL_FALSE;
...
{	
	...
	{                                    
		...
		write_cmos_sensor(0xd8, 0x16);//04
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
            		*sensor_id = GC5005_SUB_MIPI_SENSOR_ID;
...
UINT32 GC5005_SUB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
